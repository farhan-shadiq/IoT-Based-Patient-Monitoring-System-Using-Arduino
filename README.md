...
- [IoT Based Patient Monitoring System Using ESP8266 Microcontroller](#iot-based-patient-monitoring-system-using-esp8266-microcontroller)
  * [Features](#features)
  ...
  * [`Send_mailGui.m` - MATLAB GUI: Send Email Application](#-send-mailguim----matlab-gui--send-email-application)
    ...
    + [Code Overview](#code-overview-1)
      - [Initialization and GUI Setup](#initialization-and-gui-setup)
      - [Function: `Send_mailGui_OpeningFcn`](#function---send-mailgui-openingfcn-)
      - [Function: `Send_mailGui_OutputFcn`](#function---send-mailgui-outputfcn-)
      - [Callback Functions](#callback-functions)
      - [`edit1_Callback` and `edit1_CreateFcn`](#-edit1-callback--and--edit1-createfcn-)
      - [`pushbutton1_Callback`](#-pushbutton1-callback-)
  ...
  * [`Telemedecine.m` - Remote Health Data Monitoring](#-telemedecinem----remote-health-data-monitoring)
    ...
    + [Code Overview](#code-overview-2)
      ...
      - [Updating the GUI](#updating-the-gui)
      - [Security Note](#security-note-1)
    + [Usage](#usage-2)
  * [`send_mail_message.m` - Notifying Users via Email](#-send-mail-messagem----notifying-users-via-email)
    ...
    + [Code Overview](#code-overview-3)
      ...
      - [Handling Input Arguments](#handling-input-arguments)
      - [SMTP Configuration](#smtp-configuration)
      - [Sending the Email](#sending-the-email)
    + [Security Note](#security-note-2)
    + [Usage](#usage-3)
